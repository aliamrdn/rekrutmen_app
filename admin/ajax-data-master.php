...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = '<td><center>
					<a href="edit-ojt.php?id='.$row['id_c_pekerja'].'"  data-toggle="tooltip" title="OJT" class="btn btn-sm btn-warning"> <i class="fa fa fa-check-square"></i>  OJT</a>
	                 <a href="detail-master.php?id='.$row['id_c_pekerja'].'"  data-toggle="tooltip" title="Print Data" class="btn btn-sm btn-success"> <i class="fa fa-print"></i> </a>
                     <a href="edit-master.php?id='.$row['id_c_pekerja'].'"  data-toggle="tooltip" title="Edit" class="btn btn-sm btn-primary"> <i class="fa fa-edit"></i> edit</a> 
				     <a href="master.php?aksi=delete&id='.$row['id_c_pekerja'].'"  data-toggle="tooltip" title="Delete" onclick="return confirm(\'Anda yakin akan menghapus data '.$row['nama_pekerja'].'?\')" class="btn btn-sm btn-danger"> <i class="fa fa-trash"> </i> </a>
