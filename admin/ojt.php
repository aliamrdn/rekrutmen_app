    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Data OJT</h1>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Data OJT</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <a href="export_ojt.php" class="btn btn-sm btn-primary">Export Data </a><br/><br/>
  ...
  <script>
        $(document).ready(function() {
				var dataTable = $('#lookup').DataTable( {
					...
					"serverSide": true,
					"ajax":{
						url :"ajax-data-ojt.php", // json datasource
